...
//The protected keyword is used when the property or method inside the class only used within parent and the derived class but cannot be used outside the pant adn derived class.
